...
document.querySelector(document).ready(function () {
  ...
  var animating;
  document.querySelector('.steps').validate({
    errorClass: 'invalid',
    errorElement: 'span',
    ...
    highlight: function (element) {
      document.querySelector(element).next('span').show();
    },
    unhighlight: function (element) {
      document.querySelector(element).next('span').hide();
    },
  });
  document.querySelector('.next').click(function () {
    ...
    if (!document.querySelector('.steps').valid()) {
      return true;
    }
    ...
    document
      .querySelector('#progressbar li')
      .eq(document.querySelector('fieldset').index(next_fs))
  ...
  document.querySelector('.previous').click(function () {
    ...
    document
      .querySelector('#progressbar li')
      .eq(document.querySelector('fieldset').index(current_fs))
      .removeClass('active');
    previous_fs.show();
    current_fs.animate(
      {
...
function calcTotal() {
  ...
  var donorTotal = Number(
    jQuery('#edit-submitted-constituent-base-total-constituents').value.replace(
      /,/g,
      ''
    )
  );
  ...
  var acqAmount1 = Number(
    jQuery('#edit-submitted-acquisition-amount-1').value.replace(/,/g, '')
  );
  var acqAmount2 = Number(
    jQuery('#edit-submitted-acquisition-amount-2').value.replace(/,/g, '')
  );
  var acqTotal = 0;
  if (acqAmount1) {
  ...
  var cultAmount1 = Number(
    jQuery('#edit-submitted-cultivation-amount-1').value.replace(/,/g, '')
  );
  var cultAmount2 = Number(
    jQuery('#edit-submitted-cultivation-amount-2').value.replace(/,/g, '')
  );
  var cultTotal = 0;
  if (cultAmount1) {
  ...
  var cultAmount3 = Number(
    jQuery('#edit-submitted-cultivation-amount-3').value.replace(/,/g, '')
  );
  var cultAmount4 = Number(
    jQuery('#edit-submitted-cultivation-amount-4').value.replace(/,/g, '')
  );
  if (cultAmount3) {
  ...
  var retAmount1 = Number(
    jQuery('#edit-submitted-retention-amount-1').value.replace(/,/g, '')
  );
  var retAmount2 = Number(
    jQuery('#edit-submitted-retention-amount-2').value.replace(/,/g, '')
  );
  var retTotal = 0;
  if (retAmount1) {
...
var modules = {
  ...
  modals: {
    trigger: document.querySelector('.explanation'),
    modal: document.querySelector('.modal'),
    scrollTopPosition: null,
    init: function () {
      var self = this;
      if (self.trigger.length > 0 && self.modal.length > 0) {
        modules.$body.insertAdjacentHTML(
          'beforeend',
    ...
    triggers: function () {
      ...
      self.trigger.addEventListener('click', function (e) {
        e.preventDefault();
        var $trigger = document.querySelector(this);
      ...
      modules.$body.addEventListener('keydown', function (e) {
        if (e.keyCode === 27) {
          self.closeModal();
        }
      });
    ...
    openModal: function (_trigger, _modalId) {
      var self = this,
        ...
        $targetModal = document.querySelector('#' + _modalId);
      self.scrollTopPosition = scrollTopPosition;
      modules.$html.classList
        .add('modal-show')
    ...
    closeModal: function () {
      var self = this;
      document.querySelector('.modal-show').removeClass('modal-show');
